    ...
    <div id="container" class="clearfix">
      <div id="header">
        <table>
          <tr>
            <td>
              <h1><a href="https://ip.envs.net">What Is My IP Address? - Yet Another ifconfig</a></h1>
            </td>
            <td></td>
          </tr>
          <tr>
...
<!-- Ads end -->
      ...
      <div id="cli_wrap">
        ...
        <table id="cli_table" summary="cli">
          <tr><td class="cli_command">$ curl ip.envs.net</td><td class="cli_arrow">&rArr;</td><td>{{.IP}}</td></tr>
          <tr><td class="cli_command">$ curl ip.envs.net/ip</td><td class="cli_arrow">&rArr;</td><td>{{.IP}}</td></tr>
          <tr><td class="cli_command">$ curl ip.envs.net/host</td><td class="cli_arrow">&rArr;</td><td>{{.Host}}</td></tr>
          <tr><td class="cli_command">$ curl ip.envs.net/ua</td><td class="cli_arrow">&rArr;</td><td>{{.UserAgent}}</td></tr>
          <tr><td class="cli_command">$ curl ip.envs.net/port</td><td class="cli_arrow">&rArr;</td><td>{{.Port}}</td></tr>
          <tr><td class="cli_command">$ curl ip.envs.net/lang</td><td class="cli_arrow">&rArr;</td><td>{{.Lang}}</td></tr>
          <tr><td class="cli_command">$ curl ip.envs.net/keepalive</td><td class="cli_arrow">&rArr;</td><td>{{.Keepalive}}</td></tr>
          <tr><td class="cli_command">$ curl ip.envs.net/connection</td><td class="cli_arrow">&rArr;</td><td>{{.Connection}}</td></tr>
          <tr><td class="cli_command">$ curl ip.envs.net/encoding</td><td class="cli_arrow">&rArr;</td><td>{{.Encoding}}</td></tr>
          <tr><td class="cli_command">$ curl ip.envs.net/mime</td><td class="cli_arrow">&rArr;</td><td>{{.Mime}}</td></tr>
          <tr><td class="cli_command">$ curl ip.envs.net/charset</td><td class="cli_arrow">&rArr;</td><td>{{.Charset}}</td></tr>
          <tr><td class="cli_command">$ curl ip.envs.net/via</td><td class="cli_arrow">&rArr;</td><td>{{.Via}}</td></tr>
          <tr><td class="cli_command">$ curl ip.envs.net/forwarded</td><td class="cli_arrow">&rArr;</td><td>{{.Forwarded}}</td></tr>
          <tr><td class="cli_command">$ curl ip.envs.net/all</td><td class="cli_arrow">&rArr;</td><td>ip_addr: {{.IP}}<br />remote_host: {{.Host}} <br />user_agent: {{.UserAgent}}<br />port: {{.Port}}<br />lang: {{.Lang}}<br />connection: {{.Connection}}<br />keep_alive: {{.Keepalive}}<br />encoding: {{.Encoding}}<br />mime: {{.Mime}}<br />charset: {{.Charset}}<br />via: {{.Via}}<br />forwarded: {{.Forwarded}}<br /></td></tr>
          <tr><td class="cli_command">$ curl ip.envs.net/all.xml</td><td class="cli_arrow">&rArr;</td><td>&lt;info&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&lt;charset&gt;{{.Charset}}&lt;/charset&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&lt;connection&gt;{{.Connection}}&lt;/connection&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&lt;encoding&gt;{{.Encoding}}&lt;/encoding&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&lt;forwarded&gt;{{.Forwarded}}&lt;/forwarded&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&lt;ip_addr&gt;{{.IP}}&lt;/ip_addr&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&lt;keep_alive&gt;{{.Keepalive}}&lt;/keep_alive&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&lt;lang&gt;{{.Lang}}&lt;/lang&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&lt;mime&gt;{{.Mime}}&lt;/mime&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&lt;port&gt;{{.Port}}&lt;/port&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&lt;remote_host&gt;{{.Host}}&lt;/remote_host&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&lt;user_agent&gt;{{.UserAgent}}&lt;/user_agent&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&lt;via&gt;{{.Via}}&lt;/via&gt;<br />
&lt;/info&gt;<br />
</td></tr>
          <tr><td class="cli_command">$ curl https://ip.envs.net/all.json</td><td class="cli_arrow">&rArr;</td><td>{"connection":"{{.Connection}}","ip_addr":"{{.IP}}","lang":"{{.Lang}}","remote_host":"{{.Host}}","user_agent":"{{.UserAgent}}","charset":"{{.Charset}}","port":"{{.Port}}","via":"{{.Via}}","forwarded":"{{.Forwarded}}","mime":"{{.Mime}}","keep_alive":"{{.Keepalive}}","encoding":"{{.Encoding}}"}</td></tr>
        </table>
      </div>
      <div id="footer">&copy; 2014 - 2016 <a href="https://ip.envs.net">https://ip.envs.net</a></div>
    </div>
  </body>
</html>
